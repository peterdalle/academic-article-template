...
pandoc "%1" -o "%~n1.pdf" --bibliography ref.bib --csl=apa6.csl --latex-engine=xelatex --number-sections --filter pandoc-citeproc -r markdown+simple_tables+table_captions+yaml_metadata_block -s -S -N -V geometry:margin=1in
GOTO End
